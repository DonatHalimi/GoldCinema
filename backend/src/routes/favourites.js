...
], handleValidation, toggleFavourite);

router.get('/mine', requireAuth, [query('type').optional().isIn(['movie', 'cinema']).withMessage('type must be "movie" or "cinema".')], handleValidation, getMyFavourites);
