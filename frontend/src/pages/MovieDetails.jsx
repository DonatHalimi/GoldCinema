  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([movieRes, showtimeRes]) => {
        ...
        const dates = [
          ...new Set(
            showtimeRes.data.showtimes.map((s) => s.date)
          ),
        ].sort();
    ...
    <div className="mx-auto max-w-5xl px-6 py-12">
      <div className="grid gap-10 sm:grid-cols-[280px_1fr]">
        ...
        <div>
          ...
          <h1 className="font-serif text-4xl font-bold text-marquee-cream">
            {movie.title}
          </h1>

          <p className="mt-4 max-w-xl leading-relaxed text-marquee-muted">
            {movie.synopsis}
          </p>
          ...
          <p className="mt-4 font-display text-2xl tracking-wide text-marquee-gold">
            ...
            <span className="font-body text-sm text-marquee-muted">
              {' '}
              per seat
            </span>
          </p>
